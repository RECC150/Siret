          ...
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div className="card" style={{ borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', border: 'none', padding: '24px', marginBottom: 0 }}>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
                ...
                <input placeholder="Buscar por nombre" value={leftFilterName} onChange={e=>setLeftFilterName(e.target.value)} className="form-control" style={{ borderRadius: '8px', padding: '12px 18px', fontSize: 15, border: '1px solid #ddd', boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.05)' }} />
              </div>
          ...
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div className="card" style={{ borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', border: 'none', padding: '24px', marginBottom: 0 }}>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
                ...
                <input placeholder="Buscar por nombre" value={rightFilterName} onChange={e=>setRightFilterName(e.target.value)} className="form-control" style={{ borderRadius: '8px', padding: '12px 18px', fontSize: 15, border: '1px solid #ddd', boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.05)' }} />
              </div>
